<section class="fullscreen" data-bg-parallax="<?= base_url() ?>assets/images/slider/unsplash2.jpg">
	<div class="container container-fullscreen">
		<div class="text-middle text-center">
			<h1 class="text-uppercase text-md text-light" data-animate="fadeInUp">Tenjo City 3 Residence</h1>
			<p class="lead text-light " data-animate="fadeInUp" data-animate-delay="600">Where Dreams Do Come True</p>
		...
		<div id="blog" class="grid-layout post-3-columns m-b-30" data-item="post-item">
			...
			<div class="post-item border">
				<div class="post-item-wrap">
					<div class="post-image">
						<a href="#">
							<img alt="" src="<?= base_url() ?>assets/images/blog/18.jpg">
						</a>
						<span class="post-meta-category"><a href="">Science</a></span>
					</div>
					<div class="post-item-description">
	...
	<div class="container">
		...
		<div class="row team-members">
			<div class="col-lg-3">
				<div class="team-member">
					<div class="team-image">
						<img src="<?= base_url() ?>assets/images/team/team5.jpg">
					</div>
					<div class="team-desc">
						<h3>Alea Smith</h3>
			...
			<div class="col-lg-3">
				<div class="team-member">
					<div class="team-image">
						<img src="<?= base_url() ?>assets/images/team/team4.jpg">
					</div>
					<div class="team-desc">
						<h3>Ariol Doe</h3>
						<span>Software Developer</span>
			...
			<div class="col-lg-3">
				<div class="team-member">
					<div class="team-image">
						<img src="<?= base_url() ?>assets/images/team/team3.jpg" width="250">
					</div>
					<div class="team-desc">
						<h3>Emma Ross</h3>
						<span>Software Developer</span>
			...
			<div class="col-lg-3">
				<div class="team-member">
					<div class="team-image">
						<img src="<?= base_url() ?>assets/images/team/team2.jpg">
					</div>
					<div class="team-desc">
						<h3>Victor Loda</h3>
						<span>Software Developer</span>
